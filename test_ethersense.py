# test_ethersense.py
"""Tests for EtherSense."""

import pytest
from ethersense import EtherSenseCore, EtherSense


class TestCore:
    def setup_method(self):
        self.core = EtherSenseCore(threshold=0.75)
